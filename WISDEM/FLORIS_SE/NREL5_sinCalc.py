...
#a = {"location": {"x": 10, "y": 20}, "yaw": 0}
#b = {"location": {"x": 55, "y": 20}, "yaw": 0}
#c = {"location": {"x": 55, "y": 20}, "yaw": 50}

myFloris = floris_assembly_opt_AEP(nTurbines=1, nDirections=1, optimize_yaw=False,
...
def calcProduction(turbine_a, wind):
    ...
    turbineXinit = np.array([a_x])
    turbineYinit = np.array([a_y])

    myFloris.turbineX = turbineXinit
    myFloris.turbineY = turbineYinit
    myFloris.yaw = np.array([a_yaw])
